<section class="py-10 md:py-16 px-5 md:px-0 bg-white text-center">
    ...
    >
        ...
        <div class=" w-full min-w-[180px] md:w-[300px] h-[300px] bg-gradient-to-b from-[#fcd0a8] to-white shadow-lg rounded-xl p-4 text-sm flex-shrink-0">
            ...
            <p class="text-base lg:text-[11px] text-gray-600"><?= htmlspecialchars($client->review) ?></p>
        </div>
        <?php endforeach; ?>
