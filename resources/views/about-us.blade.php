...
<div>
    ...
    {{-- ======================= ABOUT CONTENT ======================= --}}
    <section id="about" class="flex flex-col gap-40 mt-20 mb-10">
        {{-- Vision --}}
        <article class="flex justify-between">
            <div class="flex flex-col justify-items-start justify-center pl-20">
                <h1 class="text-enjay-head text-5xl font-lexend font-light mb-5">Our Vision</h1>
                <h2 class="text-enjay-primary font-normal text-5xl mb-3">
            ...
            <img src="{{asset('storage/about-us/compass.png')}}" class="w-1/3 rounded-l-2xl" alt="Compass Image">
        </article>

        {{-- Mission --}}
        <article class="flex justify-between">  
            <img src="{{ asset('storage/about-us/skyscraper.png') }}" class="w-1/3 rounded-r-2xl" alt="Skyscraper Image">
            <div class="flex flex-col justify-items-end justify-center text-end pr-20">
                <h1 class="text-enjay-head font-lexend font-light text-5xl mb-5">Our Mission</h1>
                <h2 class="text-enjay-primary text-5xl mb-3">
                    THE NEXT ERA OF<br> INNOVATION AND<br> EXCELLENCE
                </h2>
                <p class="text-md font-light">
